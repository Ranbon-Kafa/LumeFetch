...
public sealed partial class MainWindowViewModel
{
    ...
    private ICatalogSession? _spotifySession;
    ...
    public string SpotifyRedirectUri => _spotifySession?.CallbackUri ?? string.Empty;
    ...
    private void InitializeCollections(AppSettings settings, IMediaCollectionProvider? collections,
        IMediaResolver? spotifyResolver, ITrackSearch? search, ICatalogSession? spotifySession)
    {
